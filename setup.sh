...
echo "🔗 Chain Reaction - Header Connect Button Fix"
echo "=============================================="
...
echo "✅ components/game/Header.tsx - With connect button"
...
echo "=============================================="
echo ""
echo "When wallet NOT connected:"
echo "  ┌──────────────────────────────────┐"
echo "  │ ⚗️ Chain Reaction    [🔗 Connect]│"
echo "  └──────────────────────────────────┘"
echo ""
echo "When wallet IS connected:"
echo "  ┌──────────────────────────────────────────┐"
echo "  │ ⚗️   🔥3  ⚡1,250  Lv.2   [👤 0x12..ab]│"
echo "  └──────────────────────────────────────────┘"
echo ""
echo "Run: chmod +x header-connect-fix.sh && ./header-connect-fix.sh"